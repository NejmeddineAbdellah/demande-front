    ...
    const handleConfirmDelete = () => {
        axios.delete(`http://localhost:8060/api/demande/delete/${deleteId}`)
            .then(() => {
                ...
                setDemandes(prevDemandes => prevDemandes.filter(demande => demande.id !== deleteId));
                setFilteredDemandes(prevFilteredDemandes => prevFilteredDemandes.filter(demande => demande.id !== deleteId));
